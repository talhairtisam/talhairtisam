...
export function CorePosterStatic({ className }: { className?: string }) {
  return (
    <div className={cn(className, "core-poster-bg")} aria-hidden>
